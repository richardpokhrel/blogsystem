...
import { NewsCard } from "./ArticleCard";
...
const newsArticles = [
  ...
  },
  {
    ...
    excerpt:
      "Over 200 executives gathered to discuss the future of digital transformation in the post-pandemic economy.",
    category: "Events",
    date: "2023-11-10",
    readTime: "6 min",
    featured: false,
  ...
  },
  {
    ...
    excerpt:
      "Strategic alliance with international firm opens doors to three new markets across Asia and Europe.",
    category: "Business",
    date: "2023-11-05",
    readTime: "3 min",
    featured: false,
  ...
  },
  {
    ...
    excerpt:
      "Our innovative workplace health initiative has been awarded the prestigious Workplace Excellence Award.",
    category: "Culture",
    date: "2023-10-28",
    readTime: "5 min",
    featured: false,
  ...
  },
  {
    ...
    excerpt:
      "Strong performance across all business units leads to 22% year-over-year revenue growth.",
    category: "Financial",
    date: "2023-10-20",
    readTime: "7 min",
    featured: false,
  ...
  },
  {
    ...
    excerpt:
      "Preview of our next-generation solutions that will redefine customer experiences in our industry.",
    category: "Products",
    date: "2023-10-15",
    readTime: "4 min",
    featured: false,
...
export default function HeroPage() {
  ...
  return (
    <>
      ...
      <div className="container max-w-7xl mb-12 px-4 sm:px-6 lg:px-8">
        <h2 className="mb-8 text-center text-2xl font-bold tracking-tight sm:text-left">Latest Updates</h2>
